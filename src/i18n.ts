...
export const t = {
  el: {
    ...
    lithos: 'Λίθος',
    heroQuote: '"τόπος συνάντησης\nκάθε καλοκαίρι"',
    philosophyTitle: '"η φιλοσοφία της οικογένειας\nκαι των ανθρώπων μας"',
    philosophyIntro: 'Περιηγηθείτε στις εμπειρίες που σας περιμένουν στην Εύβοια.',
    exploreItems: [
      {
        id: 'sea',
        title: 'θάλασσα',
        description: 'Απολαύστε την αύρα του Αιγαίου και τα καταγάλανα νερά του Ευβοϊκού. Ένα καταφύγιο γαλήνης όπου το απέραντο γαλάζιο συναντά τον ουρανό.',
        activities: ['Παραλία Αγίας Άννας', 'Παραλία Σαρακήνικο', 'Βόλτες στον Ευβοϊκό', 'Ψάρεμα και θαλάσσια σπορ'],
      },
      {
        id: 'mountain',
        title: 'βουνό',
        description: 'Ανακαλύψτε την άγρια ομορφιά και τα κρυφά μονοπάτια της Εύβοιας. Η ενέργεια της φύσης και τα απόκρημνα τοπία σας προσκαλούν σε αξέχαστες στιγμές εξερεύνησης.',
    ...
    today2: 'Κάθε επισκέπτης αντιμετωπίζεται με τη φροντίδα που προσφερόταν πάντα στα μέλη της οικογένειας: με απλές, ουσιαστικές χειρονομίες και μια αίσθηση οικειότητας.',
    today3: 'Στόχος είναι ο ξενώνας να αποτελέσει σημείο αναφοράς για κάθε νέο επισκέπτη που αναζητά έναν τόπο αυθεντικό, ζεστό και αληθινό.',
    todayQuote: 'Έναν τόπο που σε κάνει να θέλεις να επιστρέφεις, ξανά και ξανά.\nΣαν να επιστρέφεις στο δικό σου σπίτι.',
    conceptTitle: 'Κεντρική Ιδέα',
    conceptSubtitle: 'Σημείο συνάντησης.',
    ...
    concept3: 'Κατά τη σχεδίαση αντλούμε έμπνευση από τις πέτρες και τα φυσικά τοπία της περιοχής, διατηρώντας την παραδοσιακή αισθητική μέσα από μια σύγχρονη οπτική.',
    concept4: 'Η χρήση χαρακτικών τεχνικών προσδίδει αυθεντικότητα, ενισχύοντας το στοιχείο του χειροποίητου.',
    ...
    bookingSuccess: 'Το αίτημα σας στάλθηκε επιτυχώς. Θα επικοινωνήσουμε σύντομα μαζί σας στο email που δηλώσατε.',
    newBooking: 'Νέα Κράτηση',
    selectedDates: 'Επιλεγμένες Ημερομηνίες:',
    selectDates: 'Παρακαλώ επιλέξτε ημερομηνίες άφιξης και αναχώρησης.',
    fullName: 'Ονοματεπώνυμο *',
    email: 'Email *',
    phone: 'Τηλέφωνο επικοινωνίας',
    guestsLabel: 'Αριθμός Επισκεπτών *',
    guestSuffix: 'Επισκέπτες',
    msg: 'Μήνυμα / Ιδιαίτερες ανάγκες',
    send: 'Αίτημα Κράτησης',
    sending: 'Αποστολή...',
    error: 'Προέκυψε σφάλμα κατά την αποστολή. Δοκιμάστε ξανά.',
    locationTitle: 'Τοποθεσία',
    locationText: 'Βρισκόμαστε στην πανέμορφη Οκτωνιά Εύβοιας, ένα γραφικό σημείο όπου το βουνό συναντά το γαλάζιο του Αιγαίου.',
    getDirections: 'Οδηγίες πρόσβασης',
    tapToActivateMap: 'Πατήστε για ενεργοποίηση χάρτη',
    lockMap: 'Κλείδωμα χάρτη',
    contact: 'Επικοινωνία',
    footerTagline: 'Ένας τόπος αυθεντικός, ζεστός και αληθινός, όπου θάλασσα και βουνό συναντιούνται.',
    terms: 'Όροι Χρήσης',
  ...
  en: {
    ...
    lithos: 'Lithos',
    heroQuote: '"a meeting point\nevery summer"',
    philosophyTitle: '"the philosophy of our family\nand our people"',
    philosophyIntro: 'Explore the experiences awaiting you in Evia.',
    exploreItems: [
      {
        id: 'sea',
        title: 'sea',
        description: 'Enjoy the breeze of the Aegean and the azure waters of the Euboean Gulf. A haven of tranquility where the endless blue meets the sky.',
        activities: ['Agia Anna Beach', 'Sarakiniko Beach', 'Walks in Evia', 'Fishing & Water Sports'],
      },
      {
        id: 'mountain',
        title: 'mountain',
        description: 'Discover the wild beauty and hidden paths of Evia. The energy of nature and the rugged landscapes invite you to unforgettable moments of exploration.',
      ...
      },
      {
        id: 'sun',
        title: 'sun / family',
        description: 'Moments of sharing, laughter and joy under the Greek sun. Where family comes together to make unforgettable memories.',
        activities: ['Breakfast in the garden', 'Playing in nature', 'Afternoon coffee', 'Board games in the yard'],
      },
      {
        id: 'bbq',
        title: 'barbecue / welcome',
        description: 'The heart of hospitality beats here. Around the fire, we share flavors, stories, and authentic Greek hospitality.',
    ...
    today2: 'Every guest is treated with the care that was always offered to family members: with simple, meaningful gestures and a sense of familiarity.',
    today3: 'The goal is for the guesthouse to be a reference point for every new guest looking for an authentic, warm, and real place.',
    todayQuote: 'A place that makes you want to return, again and again.\nAs if returning to your own home.',
    conceptTitle: 'The Concept',
    conceptSubtitle: 'Meeting point.',
    ...
    concept3: 'During the design process, we draw inspiration from the stones and natural landscapes of the area.',
    concept4: 'The use of engraving techniques adds authenticity, enhancing the handmade element.',
    galleryTitle: 'Gallery',
    ...
    bookingSuccess: 'Your request has been sent successfully. We will contact you soon at the email you provided.',
    ...
    locationText: 'We are located in beautiful Oktonia, Evia — a picturesque spot where mountain meets the blue of the Aegean.',
    getDirections: 'Get Directions',
    tapToActivateMap: 'Tap to activate map',
    lockMap: 'Lock map',
    contact: 'Contact',
    footerTagline: 'An authentic, warm and real place where sea and mountain meet.',
    terms: 'Terms of Use',
    privacy: 'Privacy Policy',
    allRightsReserved: 'All rights reserved.',
    cookieConsentAll: 'Accept all',
    cookieConsentEssential: 'Essential only',
    cookieText: 'We use cookies to ensure the best browsing experience on our site and for booking functionality.',
    close: 'Close',
  },
} as const;
